...
<body class="is-preload">
	...
	<div id="header">
		...
		<div class="top">
			...
			<nav id="nav">
				<ul>
					<li><a href="/ProjectJPA2/IndexController?id=3" id="contact-link"><span
		...
		<section id="contact" class="four">
			<div class="container">
				<div class="container mt-3">
					...
					<form action="/ProjectJPA2/Buscar?id=1" method="POST">
					...
					<form action="/ProjectJPA2/Buscar?id=2" method="POST">
						<div class="input-group mb-3 input-group-sm">
							<div class="input-group-prepend">
